...
public class KNNTest {
	...
	public static void knnClassifyTest() {
		...
		byte[][][] imagesTrain = KNN.parseIDXimages(Helpers.readBinaryFile("mp/datasets/10-per-digit_images_train"));
		byte[] labelsTrain = KNN.parseIDXlabels(Helpers.readBinaryFile("mp/datasets/10-per-digit_labels_train"));
